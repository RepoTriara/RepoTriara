        ...
        <div class="main_content">
            ...
            {{ $file->public_allow ? url('download.php?id=' . $file->id . '&token=' . $file->public_token) : 'La descarga pública está deshabilitada para este archivo.' }}
                                                        ...
                                                        <div class="checkbox">
                                                            <label for="hid_checkbox">
                                                                <input type="checkbox" id="hid_checkbox"
                                                                    name="file[1][hidden]" value="1" /> Marcar
                                                                como oculto (no se enviaran notificaciones) para
                                                                clientes y grupos nuevos. </label>
                                                        </div>
                                                        <div class="checkbox">
                                                            <label for="hid_existing_checkbox">
                                                                <input type="checkbox" id="hid_existing_checkbox"
                                                                    name="file[1][hideall]" value="1" /> Ocultar
                                                                a todos los clientes y grupos ya asignados. </label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="after_form_buttons">
                            <a href="https://repo.triara.co/repositorio/manage-files.php" name="cancel"
