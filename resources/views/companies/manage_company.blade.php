                ...
                <div class="form_actions_right">
                    <div class="form_actions">
                        <div class="form_actions_submit" style="display: flex; align-items: center;">
                            ...
                            <select name="action" id="do_action" class="txtfield form-control" style="width: auto; margin-right: 10px;">
                                <option value="none">Seleccione la acción</option>
                                <option value="delete">Eliminar</option>
                            </select>
                            <button type="submit" id="do_action_button" class="btn btn-sm btn-default">Proceder</button>
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center; width: 110px;" class="{{ request('sort') === 'created_by' ? 'footable-sorted-desc footable-visible footable-sorted-active active' : 'footable-visible' }}" data-hide="phone,tablet">
                                <a href="{{ request()->fullUrlWithQuery(['sort' => 'created_by', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}" style="display: inline-flex; align-items: center; justify-content: center; gap: 5px;">
                                    Creado por
