                    ...
                    <div class="d-inline-block" style="margin-top: 10px;">
                        <form class="form-inline d-inline-block">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" style="width: auto;" name="page"
                                    id="go_to_page" value="{{ $groups->currentPage() }}" min="1"
                                    max="{{ $groups->lastPage() }}" />
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="mt-3">Envíe esta URL a alguien para ver los contenidos permitidos del grupo acorde
                            con
