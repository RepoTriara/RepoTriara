            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <b>
                            <p class="text-muted">
                                Favor, complete la siguiente información para finalizar el proceso de carga. Recuerde que "Título", "Asignación" y "Categoría" son campos obligatorios.
                            </p>
                        </b>
                                    ...
                                    <tr style="background-color: rgb(235, 240, 245);">
                                        ...
                                        <th>
                                            <a href="{{ request()->fullUrlWithQuery(['sort' => 'original_url', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}"
                                                style="color: black; text-decoration: none !important;">
                                                Nombre del Archivo
                                                <i class="fa fa-sort{{ request('sort') === 'original_url' ? (request('direction') === 'asc' ? '-up' : '-down') : '' }}"></i>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="{{ request()->fullUrlWithQuery(['sort' => 'hidden', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}"
                                                style="color: black; text-decoration: none !important;">
                                                Estado
                                                <i class="fa fa-sort{{ request('sort') === 'hidden' ? (request('direction') === 'asc' ? '-up' : '-down') : '' }}"></i>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="{{ request()->fullUrlWithQuery(['sort' => 'file_relations_count', 'direction' => request('direction') === 'asc' ? 'desc' : 'asc']) }}"
                                                style="color: black; text-decoration: none !important;">
                                                Asignaciones
                                                <i class="fa fa-sort{{ request('sort') === 'file_relations_count' ? (request('direction') === 'asc' ? '-up' : '-down') : '' }}"></i>
                                            </a>
                                        </th>
                                        <th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span class="label {{ $isHidden ? 'label-danger' : 'label-success' }}">
                                                Visible
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#urlModal" data-url="{{ url('repositorio/public.php?id=' . $savedFile->id . '&token=' . $savedFile->public_token) }}">Público</button>
                                            @else
