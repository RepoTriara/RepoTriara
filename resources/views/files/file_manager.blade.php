                    ...
                    <div class="col-xs-12">
                        <div class="form_actions_left">
                            <div class="form_actions_limit_results">
                                ...
                                <form action="{{ route('file_manager', ['groupId' => $group->id ?? '']) }}" method="GET"
                                    class="form-inline">
                        ...
                        <form action="{{ route('files.bulk-action') }}" method="POST" id="bulkActionForm">
                            ...
                            <div class="form_actions_count">
                                @if(request()->has('category_id'))  <!-- Chequea si se está filtrando por categoría -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-3">Envíe esta URL a alguien para que descargue el archivo sin necesidad de registrarse
                        o iniciar sesión.</p>
                </div>
                <div class="modal-footer">
