...
<li class="separator"></li><li class="separator"></li></ul>
		...
		<div class="main_content">
			<div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <strong>Actualización disponible</strong> ProjectSend 1720 has been released                            </div>
...
<div class="col-xs-12">
			<p>
			<div class="alert alert-info">Haz clic en Añadir archivos para seleccionar todos los archivos que quieras subir, y luego haga clic en continuar. En el siguiente paso, podrá establecer un nombre y descripción de cada archivo cargado. Recuerde que el tamaño maximo permitido por archivo (en mb.) es  <strong>2048</strong></div>		</p>
		...
		<script type="text/javascript">
			...
			$(function() {
				$("#uploader").pluploadQueue({
					...
					multipart : true,
												filters : [
								{title : "Allowed files", extensions : "7z,ace,ai,avi,bin,bmp,bz2,cdr,doc,docm,docx,eps,fla,flv,gif,gz,gzip,htm,html,iso,jpeg,jpg,mp3,mp4,mpg,odt,oog,ppt,pptx,pptm,pps,ppsx,pdf,png,psd,rar,rtf,tar,tif,tiff,tgz,txt,wav,xls,xlsm,xlsx,xz,zip"}
							],
