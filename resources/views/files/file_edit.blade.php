...
<div class="checkbox">
    <label for="exp_checkbox">
        <input type="checkbox" id="exp_checkbox" name="expires" value="1" 
    ...
    <a href="#" class="btn btn-xs btn-primary remove-all" data-type="categories">Borrar todo</a>
                                                    ...
                                                    <div class="checkbox">
                                                        <label for="hid_checkbox">
                                                            <input type="checkbox" id="hid_checkbox" name="file[1][hidden]" value="1" /> Marcar como oculto (no se enviaran notificaciones) para clientes y grupos nuevos. </label>
                                                    </div>
                                                    <div class="checkbox">
                                                        <label for="hid_existing_checkbox">
                                                            <input type="checkbox" id="hid_existing_checkbox" name="file[1][hideall]" value="1" /> Ocultar a todos los clientes y grupos ya asignados. </label>
                                                    </div>
                                            </div>
                ...
                <div class="after_form_buttons">
                    <a href="https://repo.triara.co/repositorio/manage-files.php" name="cancel" class="btn btn-default btn-wide">Cancelar</a>
