<div class="main_side_menu">
    ...
    <ul class="main_menu" role="menu">
        ...
        <li class="has_dropdown {{ request()->routeIs('add_client') || request()->routeIs('customer_manager') ? 'current_nav' : '' }}">
            ...
            <ul class="dropdown_content">
                <li><a href="{{ route('add_client') }}"><span class="submenu_label">Añadir nuevo cliente</span></a></li>
                <li><a href="{{ route('customer_manager') }}"><span class="submenu_label">Administración de clientes</span></a></li>
            </ul>
        </li>
        ...
        <li class="has_dropdown {{ request()->routeIs('add_company') || request()->routeIs('manage_company') ? 'current_nav' : '' }}">
            ...
            <ul class="dropdown_content">
                <li><a href="{{ route('add_company') }}"><span class="submenu_label">Añadir nueva compañía</span></a></li>
                <li><a href="{{ route('manage_company') }}"><span class="submenu_label">Administrar compañías</span></a></li>
            </ul>
        </li>
        ...
        <li class="has_dropdown {{ request()->routeIs('add_user') || request()->routeIs('manage_users') ? 'current_nav' : '' }}">
            ...
            <ul class="dropdown_content">
                <li><a href="{{ route('add_user') }}"><span class="submenu_label">Añadir nuevo usuario</span></a></li>
                <li><a href="{{ route('manage_users') }}"><span class="submenu_label">Administrar usuarios</span></a></li>
            </ul>
        </li>
        @endif
